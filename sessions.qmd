...
[R script](documents/session-3.R)\
[RMarkdown script](documents/_notebook-session-3.Rmd)
...
We will also discuss a workflow for starting from raw data to a `vegtable`
object.

[R script](documents/session-4.R)\
[RMarkdown script](documents/_notebook-session-4.Rmd)
